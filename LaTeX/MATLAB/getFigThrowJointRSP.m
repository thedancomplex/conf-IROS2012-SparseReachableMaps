...
figure
subplot(3,1,1)
plot(t,rspA,'LineWidth',lineWidth)
hold on
plot(t,rspD,'r--','LineWidth',lineWidth)
...
subplot(3,1,2)
dD = diff(rspD)/T;
plot(t(2:length(t)),dD,'LineWidth',lineWidth)
hold on
dA = diff(rspA)/T;
dA(1) = dA(2);
plot(t(2:length(t)),dA,'r--','LineWidth',lineWidth)
...
subplot(3,1,3)
ddD = diff(dD)/T;
plot(t(3:length(t)),ddD,'LineWidth',lineWidth)
hold on
ddA = diff(dA)/T;
plot(t(3:length(t)),ddA,'r--','LineWidth',lineWidth)
...
figure
subplot(2,1,1)
plot(t,sD,'LineWidth',lineWidth)
hold on
plot(t,sA,'r--','LineWidth',lineWidth)
grid on
axis([ ts, te -4, 12])
