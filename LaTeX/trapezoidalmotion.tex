...
time step, the controller only needs to drive the joint to the sliding surface. To be on this surface, the current velocity
...
]\eqref{eq:vcrit}, $v_0 \cdot \hat{u}$ is the velocity towards the goal direction,
